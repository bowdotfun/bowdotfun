...
This is factored out into [`scripts/bowConfig.js`](../scripts/bowConfig.js) so every
...
checksummed `b03`. See [`scripts/bowLaunch.js`](../scripts/bowLaunch.js) for the
...
[`scripts/bowBuy.js`](../scripts/bowBuy.js).
...
[`scripts/bowSell.js`](../scripts/bowSell.js).
...
see [`scripts/bowQuote.js`](../scripts/bowQuote.js) — then apply your slippage
...
[`scripts/bowCollectFees.js`](../scripts/bowCollectFees.js) to trigger collection,
and [`scripts/bowPreviewFees.js`](../scripts/bowPreviewFees.js) to preview the
pending amount without spending anything (via `staticCall`).

## Read state

[`scripts/bowReadState.js`](../scripts/bowReadState.js) covers:
